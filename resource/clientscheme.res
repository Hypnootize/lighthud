"Scheme"
{
    ...
    "Colors"
    {
        ...
        "CreditsGreen"                                      "160 217 224 255" // changed for friends status (cant find another way to do this)
    ...
    "BaseSettings"
    {
        ...
        "Econ.Dialog.BgColor"                               "FooterBGBlack"
        "Econ.Button.BgColor"                               "FooterBGBlack"
        "Econ.Button.FgColor"                               "White"
        "Econ.Button.ArmedBgColor"                          "White"
        "Econ.Button.ArmedFgColor"                          "FooterBGBlack"
        "Econ.Button.DepressedBgColor"                      "White"
        "Econ.Button.DepressedFgColor"                      "FooterBGBlack"

        "Econ.Button.PresetDefaultColorFg"                  "White"
        "Econ.Button.PresetArmedColorFg"                    "White"
        "Econ.Button.PresetDepressedColorFg"                "White"

        "Econ.Button.PresetDefaultColorBg"                  "FooterBGBlack"
        "Econ.Button.PresetArmedColorBg"                    "FooterBGBlack"
        "Econ.Button.PresetDepressedColorBg"                "FooterBGBlack"
        ...
        "Button.BgColor"                                    "FooterBGBlack"
        "Button.ArmedTextColor"                             "FooterBGBlack"
        "Button.ArmedBgColor"                               "White"
        "Button.SelectedTextColor"                          "White"
        "Button.SelectedBgColor"                            "FooterBGBlack"
        "Button.DepressedTextColor"                         "FooterBGBlack"
